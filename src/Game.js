...
class Game {
  ...
  getPlayers() {
    // const player1 = new Player($('#player-1-input').val());
    // const player2 = new Player($('#player-2-input').val());
    // $('.player-1-name').text($('#player-1-input').val());
    // $('.player-2-name').text($('#player-2-input').val());
  }
